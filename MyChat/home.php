			...
			<div class="col-md-3 col-sm-3 col-xs-12 left-sidebar">
				<div class="input-group searchbox">
					<div class="input-group-btn">
						<button name="menu" class="btn btn-success" style="border-right: 5px;"><a href="include/find_friends.php"><i class="fa fa-bars" aria-hidden="true" style="color: white; size: 35px;"> Menu</i></a></button>
					</div>
				</div>
				<div class="left-chat">
					<ul>
			...
			<div class="col-md-9 col-sm-9 col-xs-12 right-sidebar">
				...
				<div class="row">
					<div class="col-md-12 right-chat-textbox">
						...
						<button class="btn" name="submit"><i class="fa fa-rocket" aria-hidden="true"></i></button>
						</form>
					</div>
				</div>
			</div>
